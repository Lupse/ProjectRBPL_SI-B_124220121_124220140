    ...
    <div class="container-fluid">
        <div class="row" style="height:84.5vh;">
            ...
            <div class="col-10 p-5">
                <h3 class="mb-5">Edit Data Produk</h3>
                <?php
                ...
                <form action="proses/editproduk.php" method="POST">
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Id Produk</label>
                    <input type="text" value="<?= $row['id_barang']; ?>" disabled  class="form-control" id="exampleInputEmail1" >
                    <input type="hidden" value="<?= $row['id_barang']; ?>" name="id">
                </div>
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Nama Produk</label>
                    <input type="text" value="<?= $row['nama']; ?>" name="nama" class="form-control" id="exampleInputEmail1" >
                </div>
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Harga</label>
                    <input type="text" value="<?= $row['harga']; ?>" name="harga" class="form-control" id="exampleInputEmail1" >
                </div>
