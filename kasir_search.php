<?php
    ...
    if(mysqli_num_rows($result)<=0){
        echo "<script>alert('Id Barang tidak ditemukan.');window.location.href='kasir.php';</script>";
    }
?>
...
<body>
    ...
    <div class="container-fluid">
        <div class="row border border-1">
            ...
            <div class="col-8 border border-1" style="height: 65vh;">
                    <div style="  overflow: auto; width: 100%;height: 64.6vh;">
                       ...
                       <!-- BACK BUTTON -->
                            <a class="btn btn-outline-secondary" type="submit" href="kasir.php">Kembali</a>
                        <!-- BACK BUTTON END -->
                        <!-- TABLE -->
        ...
        <!-- TOTAL HARGA -->
        <div class="container-fluid" style="display: flex; align-items: center;justify-content:space-between; height:19.3vh;">
            <div class="kiri">
                <h1>Total Harga</h1>
            </div>
